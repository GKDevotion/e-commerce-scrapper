...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/analytics-settings',       [AdminController::class, 'analyticsSettings'])->name('analytics.settings');
    Route::post('/analytics-settings/{analytics}', [AdminController::class, 'updateAnalytics'])->name('analytics.settings.update');

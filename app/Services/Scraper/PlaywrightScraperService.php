    ...
    public function scrapeAndStore(ProductImport $import): ProductImport
    {
        ...
        try {
            ...
            $import->update([
                ...
                'original_bullet_points'  => $data['bullets'] ?? $data['bullet_points'] ?? [],
                'original_specifications' => $data['specifications'],
                'original_images'         => $data['images'],
                'original_category'       => $data['category'],
                'original_attributes'     => $data['attributes'] ?? $data['specifications'] ?? [],
                'product_weight'          => $data['weight'] ?? null,
                'product_dimensions'      => $data['dimensions'] ?? null,

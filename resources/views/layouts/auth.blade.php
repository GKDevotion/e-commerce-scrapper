...
<head>
    ...
    <title>@yield('title') — Seller Forge</title>
...
<body>
    ...
    <div class="auth-left">
        <div class="auth-logo">
            <img src="{{ asset('public/images/logo.png') }}" alt="Seller Forge Logo" class="auth-logo-icon">
        </div>

        <div class="auth-tagline">
            <h2>AI-Powered Listings That Sell</h2>
            <p>Import any Amazon or Flipkart product URL and generate unique, branded listings in seconds. Powered by
                GPT-4o.</p>
        </div>

        <div class="auth-features">
            <div class="auth-feature"><i class="bi bi-check-circle-fill"></i> Scrape Amazon & Flipkart products</div>
            ...
            <div class="auth-feature"><i class="bi bi-check-circle-fill"></i> Export to CSV, Excel, Flat File, PDF</div>

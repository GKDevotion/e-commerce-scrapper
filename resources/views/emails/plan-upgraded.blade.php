...
<style>body{margin:0;padding:0;background:#F4F6F9;font-family:Inter,-apple-system,sans-serif;}.wrap{max-width:560px;margin:40px auto;background:white;border-radius:14px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.06);}.hdr{background:linear-gradient(135deg,#d09226,#b01028);padding:28px 36px;text-align:center;}.hdr-t{font-size:16px;font-weight:700;color:white;margin:0;}.body{padding:36px;}h2{font-size:22px;font-weight:700;color:#111827;margin:0 0 12px;}p{font-size:14.5px;color:#6B7280;line-height:1.7;margin:0 0 14px;}.plan-box{background:#FFF5F5;border:1.5px solid #FEE2E8;border-radius:12px;padding:20px 24px;margin:20px 0;}.plan-name{font-size:24px;font-weight:800;color:#d09226;margin:0 0 6px;}.plan-price{font-size:16px;color:#374151;margin:0;}.feat{font-size:13.5px;color:#374151;margin:6px 0;}.btn{display:inline-block;background:#d09226;color:white;text-decoration:none;font-size:15px;font-weight:700;padding:13px 30px;border-radius:10px;margin:20px 0;}.ftr{background:#F9FAFB;padding:20px 36px;text-align:center;border-top:1px solid #F3F4F6;}.ftr p{font-size:12px;color:#9CA3AF;margin:3px 0;}.ftr a{color:#d09226;text-decoration:none;}</style>
</head><body>
<div class="wrap">
  ...
  <div class="body">
    ...
    <p style="font-size:13px;">Manage at <a href="{{ config('app.url') }}/billing/subscription" style="color:#d09226;">Billing Settings</a>.</p>
  </div>
  <div class="ftr">

...
<?php $__env->startSection('page-title', 'Edit Listing'); ?>

<?php $__env->startSection('topbar-actions'); ?>
<a href="<?php echo e(route('generations.view', $generation->id)); ?>" class="topbar-btn" style="background:#374151;">
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4 fade-in-up">
    <div>
        <div style="font-size:12.5px;color:#9CA3AF;margin-bottom:4px;">
            ...
            <a href="<?php echo e(route('generations.view', $generation->id)); ?>" style="color:#9CA3AF;text-decoration:none;"><?php echo e($generation->generation_name_display); ?></a>
            <span class="mx-1">›</span>
    ...
    <span style="background:<?php echo e($generation->isAi() ? '#FEE2E8' : '#FEF3C7'); ?>;color:<?php echo e($generation->isAi() ? '#E31837' : '#92400E'); ?>;font-size:12px;font-weight:700;padding:5px 14px;border-radius:20px;">
...
<div class="row justify-content-center">
    <div class="col-lg-9 fade-in-up">
        <div class="alb-card">
            <form method="POST" action="<?php echo e(route('generations.update', $generation->id)); ?>" id="editForm">
                ...
                <div class="alb-form-group">
                    ...
                    <input type="text" name="generation_name" class="alb-input" value="<?php echo e(old('generation_name', $generation->generation_name)); ?>">
                </div>

                <div class="row g-3 mb-1">
                    <div class="col-md-6">
                        <label class="alb-label">Brand Name <span style="color:#E31837;">*</span></label>
                        <input type="text" name="brand_name" class="alb-input" value="<?php echo e(old('brand_name', $generation->brand_name)); ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="alb-label">Manufacturer <span style="color:#E31837;">*</span></label>
                        <input type="text" name="manufacturer" class="alb-input" value="<?php echo e(old('manufacturer', $generation->manufacturer)); ?>" required>
                    </div>
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">Product Title <span style="color:#E31837;">*</span></label>
                    <input type="text" name="generated_title" class="alb-input" value="<?php echo e(old('generated_title', $generation->generated_title)); ?>" required maxlength="500">
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">Bullet Points <span style="color:#E31837;">*</span></label>
                    <div id="bulletsContainer">
                        <?php $editBullets = old('generated_bullet_points', $generation->generated_bullet_points ?: ['']); ?>
                        <?php $__currentLoopData = $editBullets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bullet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="alb-form-group">
                    ...
                    <textarea name="generated_description" class="alb-input alb-textarea" style="min-height:160px;" required><?php echo e(old('generated_description', $generation->generated_description)); ?></textarea>
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">Backend Search Terms</label>
                    <textarea name="generated_search_terms" class="alb-input" style="min-height:70px;"><?php echo e(old('generated_search_terms', $generation->generated_search_terms)); ?></textarea>
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">SEO Keywords</label>
                    <textarea name="generated_seo_keywords" class="alb-input" style="min-height:70px;"><?php echo e(old('generated_seo_keywords', $generation->generated_seo_keywords)); ?></textarea>
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">Product Highlights</label>
                    <textarea name="generated_highlights" class="alb-input alb-textarea"><?php echo e(old('generated_highlights', $generation->generated_highlights)); ?></textarea>
                </div>

                <div class="alb-form-group">
                    <label class="alb-label">A+ Content</label>
                    <textarea name="generated_aplus_content" class="alb-input alb-textarea"><?php echo e(old('generated_aplus_content', $generation->generated_aplus_content)); ?></textarea>
                </div>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('generations.view', $generation->id)); ?>" class="btn-alb-outline btn" style="font-size:15px;padding:13px 32px;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
let bulletIndex = <?php echo e(count($editBullets)); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/listings/edit-generation.blade.php ENDPATH**/ ?>
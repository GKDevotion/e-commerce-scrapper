<?php $__env->startSection('title', 'My Listings'); ?>
...
<div class="alb-card mb-4 fade-in-up" style="padding:14px 20px;">
    <div class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <span style="font-size:13px;color:#9CA3AF;white-space:nowrap;"><?php echo e($imports->total()); ?> total</span>
    </div>
</div>
...
<div class="row g-3" id="listingsGrid">
    ...
    <?php $gen = $import->latestGeneration; ?>
    <div class="col-md-6 col-xl-4 fade-in-up listing-card" data-status="<?php echo e($import->status); ?>" data-title="<?php echo e(strtolower($import->original_title ?? '')); ?>">
        <div class="alb-card h-100" style="padding:0;overflow:hidden;">
            ...
            <div style="position:relative;height:140px;background:#F3F4F6;overflow:hidden;">
                ...
                <div style="position:absolute;top:10px;right:10px;">
                    ...
                    <?php elseif($import->status === 'scraped'): ?>
                ...
                <div style="position:absolute;bottom:8px;left:12px;">
                    <span style="background:rgba(0,0,0,0.6);color:rgba(255,255,255,0.8);font-size:10.5px;font-family:monospace;padding:3px 8px;border-radius:4px;">ASIN: <?php echo e($import->asin); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div style="padding:16px;">
                <div style="font-size:13.5px;font-weight:600;color:#111827;line-height:1.4;margin-bottom:8px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;">
                    <?php if($gen?->generated_title): ?>
                        <span style="color:#E31837;">✦</span> <?php echo e($gen->generated_title); ?>

                    <?php else: ?>
                        <?php echo e($import->original_title ?? 'Importing...'); ?>

                    <?php endif; ?>
                </div>
                <div style="font-size:12px;color:#9CA3AF;margin-bottom:12px;display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
                    <?php if($import->target_brand_name): ?>
                    <span><i class="bi bi-tag me-1"></i><?php echo e($import->target_brand_name); ?></span>
                    <?php endif; ?>
                    <span><i class="bi bi-clock me-1"></i><?php echo e($import->created_at->diffForHumans()); ?></span>
                </div>

                <!-- Action buttons -->
                <div class="d-flex gap-2">
                    <?php if($gen?->status === 'completed'): ?>
                    <a href="<?php echo e(route('generations.view', $gen->id)); ?>" class="btn btn-sm" style="flex:1;background:#E31837;color:white;font-size:12px;font-weight:700;border-radius:8px;padding:8px;text-align:center;text-decoration:none;border:none;">
                        <i class="bi bi-eye me-1"></i>View
                    </a>
                    <?php elseif($import->status === 'scraped'): ?>
                    <a href="<?php echo e(route('listings.show', $import->id)); ?>" class="btn btn-sm" style="flex:1;background:#E31837;color:white;font-size:12px;font-weight:700;border-radius:8px;padding:8px;text-align:center;text-decoration:none;border:none;">
                        <i class="bi bi-stars me-1"></i>Create Listing
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('listings.show', $import->id)); ?>" class="btn btn-sm" style="flex:1;background:#3B82F6;color:white;font-size:12px;font-weight:700;border-radius:8px;padding:8px;text-align:center;text-decoration:none;border:none;">
                        <i class="bi bi-hourglass-split me-1"></i>Processing
                    </a>
                    <?php endif; ?>

                    <a href="<?php echo e(route('listings.show', $import->id)); ?>" class="btn btn-sm btn-alb-outline" style="padding:8px 12px;font-size:12px;">
                        <i class="bi bi-arrow-right"></i>
                    </a>

                    <form method="POST" action="<?php echo e(route('listings.destroy', $import->id)); ?>" onsubmit="return confirm('Delete this import and all its generations?')">
...
<div class="d-flex justify-content-center mt-4">
    <?php echo e($imports->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/listings/imports.blade.php ENDPATH**/ ?>
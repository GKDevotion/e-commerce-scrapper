...
<?php $__env->startSection('page-title', 'New Listing'); ?>
    ...
    <div class="col-lg-8 col-xl-7">
        ...
        <div class="alb-card mb-4 fade-in-up" style="padding:20px 24px;">
            <div class="d-flex align-items-center justify-content-between">
                <?php $steps = ['Import URL', 'AI Generate', 'Compare & Edit', 'Export']; ?>
                ...
                <div class="d-flex align-items-center <?php echo e($i < count($steps)-1 ? 'flex-grow-1' : ''); ?>">
                    <div style="display:flex;flex-direction:column;align-items:center;gap:6px;">
                        <div style="width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;
                            background:<?php echo e($i === 0 ? '#E31837' : '#F3F4F6'); ?>;
                            color:<?php echo e($i === 0 ? 'white' : '#9CA3AF'); ?>;">
                            <?php echo e($i + 1); ?>

                        </div>
                        <span style="font-size:11px;font-weight:600;color:<?php echo e($i === 0 ? '#E31837' : '#9CA3AF'); ?>;white-space:nowrap;"><?php echo e($step); ?></span>
                    </div>
                    <?php if($i < count($steps)-1): ?>
                    <div style="flex:1;height:2px;background:<?php echo e($i === 0 ? '#E31837' : '#F3F4F6'); ?>;margin:0 8px;margin-bottom:20px;"></div>
                    <?php endif; ?>
                </div>
        ...
        <div class="alb-card fade-in-up fade-in-up-delay-1">
            ...
            <form method="POST" action="<?php echo e(route('listings.store')); ?>" id="importForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="alb-form-group">
                    ...
                    <div style="position:relative;">
                        <input type="url" name="amazon_url" id="amazonUrl"
                            class="alb-input <?php $__errorArgs = ['amazon_url'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('amazon_url')); ?>" required
                    ...
                    <?php $__errorArgs = ['amazon_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <div style="color:#EF4444;font-size:12px;margin-top:4px;"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="alb-form-group">
                            ...
                            <input type="text" name="target_brand_name"
                                class="alb-input <?php $__errorArgs = ['target_brand_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('target_brand_name', auth()->user()->default_brand)); ?>"
                                required maxlength="100">
                            <?php $__errorArgs = ['target_brand_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <div style="color:#EF4444;font-size:12px;margin-top:4px;"><?php echo e($message); ?></div>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="alb-form-group">
                            ...
                            <input type="text" name="target_manufacturer"
                                class="alb-input <?php $__errorArgs = ['target_manufacturer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('target_manufacturer', auth()->user()->default_manufacturer)); ?>"
                                required maxlength="100">
                            <?php $__errorArgs = ['target_manufacturer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="alb-form-group">
                    ...
                    <textarea name="target_keywords"
                        ...
                        maxlength="500"><?php echo e(old('target_keywords')); ?></textarea>
                    <div style="font-size:12px;color:#9CA3AF;margin-top:5px;">
                ...
                <!-- Usage Warning -->
                <?php $remaining = auth()->user()->getRemainingListings(); ?>
                <?php if($remaining !== 'Unlimited' && $remaining <= 2): ?>
                <div style="background:#FEF3C7;border:1px solid #FDE68A;border-radius:10px;padding:12px 16px;margin-bottom:20px;">
                    <div style="font-size:12.5px;color:#92400E;">
                        ...
                        <strong><?php echo e($remaining); ?> listing<?php echo e($remaining != 1 ? 's' : ''); ?> remaining</strong> on your plan.
                        <a href="<?php echo e(route('billing.plans')); ?>" style="color:#E31837;font-weight:700;">Upgrade now →</a>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/listings/create.blade.php ENDPATH**/ ?>
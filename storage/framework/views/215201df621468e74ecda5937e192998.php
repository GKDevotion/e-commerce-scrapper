<?php $__env->startSection('title', 'Listing #' . $import->id); ?>
<?php $__env->startSection('page-title', 'Listing Import'); ?>
...
<div class="row g-4">
    ...
    <div class="col-lg-5">
        ...
        <div class="alb-card mb-4 fade-in-up">
            <div class="d-flex align-items-center gap-3 mb-4">
                ...
                <img src="<?php echo e($import->primary_image); ?>" alt="Product" style="width:70px;height:70px;border-radius:10px;object-fit:cover;border:1px solid #E5E7EB;">
                <?php else: ?>
                ...
                <div style="flex:1;min-width:0;">
                    <div style="font-size:13px;font-weight:700;color:#111827;margin-bottom:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                        <?php echo e($import->original_title ?? 'Importing product...'); ?>

                    </div>
                    <?php if($import->asin): ?>
                    <div style="font-size:12px;color:#6B7280;">ASIN: <strong><?php echo e($import->asin); ?></strong></div>
                    <?php endif; ?>
                    <div style="font-size:12px;color:#9CA3AF;margin-top:2px;"><?php echo e($import->original_category ?? ''); ?></div>
                </div>
            </div>
            ...
            <div style="position:relative;">
                ...
                <div style="background:#FEE2E2;border:1px solid #FCA5A5;border-radius:10px;padding:14px 16px;margin-bottom:16px;">
                    ...
                    <div style="font-size:12.5px;color:#B91C1C;"><?php echo e($import->scrape_error); ?></div>
                    <a href="<?php echo e(route('listings.create')); ?>" style="display:inline-block;margin-top:10px;font-size:12.5px;color:#E31837;font-weight:700;text-decoration:none;">
                        Try again →
                    </a>
                </div>
                <?php else: ?>
                <div style="display:flex;flex-direction:column;gap:0;">
                    <?php $__currentLoopData = ['Queued', 'Scraping Amazon', 'Data Extracted', 'AI Generating', 'Listing Ready']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $sLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    $isDone = $currentStep > $si;
                    $isCurrent = $currentStep === $si;
                    ?>
                    <div style="display:flex;align-items:flex-start;gap:14px;<?php echo e(!$loop->last ? 'padding-bottom:16px;' : ''); ?>">
                        <div style="display:flex;flex-direction:column;align-items:center;">
                            <div style="width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;flex-shrink:0;
                                background:<?php echo e($isDone ? '#E31837' : ($isCurrent ? '#FEE2E8' : '#F3F4F6')); ?>;
                                color:<?php echo e($isDone ? 'white' : ($isCurrent ? '#E31837' : '#9CA3AF')); ?>;
                                border:<?php echo e($isCurrent ? '2px solid #E31837' : 'none'); ?>;">
                                <?php if($isDone): ?><i class="bi bi-check"></i><?php else: ?><?php echo e($si + 1); ?><?php endif; ?>
                            </div>
                            <?php if(!$loop->last): ?>
                            <div style="width:2px;flex:1;min-height:12px;background:<?php echo e($isDone ? '#E31837' : '#F3F4F6'); ?>;margin:2px 0;"></div>
                            <?php endif; ?>
                        </div>
                        <div style="padding-top:4px;">
                            <div style="font-size:13px;font-weight:<?php echo e($isCurrent ? '700' : '500'); ?>;color:<?php echo e($isDone ? '#059669' : ($isCurrent ? '#E31837' : '#9CA3AF')); ?>;">
                                <?php echo e($sLabel); ?>

                                <?php if($isCurrent && in_array($currentStatus, ['scraping','processing'])): ?>
        ...
        <div class="alb-card fade-in-up">
            ...
            <div style="display:flex;flex-direction:column;gap:12px;">
                <div>
                    ...
                    <div style="font-size:13px;color:#374151;line-height:1.4;"><?php echo e($import->original_title); ?></div>
                </div>
                ...
                <div>
                    ...
                    <div style="font-size:13px;color:#374151;"><?php echo e($import->original_brand); ?></div>
                </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <div style="font-size:12.5px;color:#374151;display:flex;gap:8px;margin-bottom:5px;">
                        ...
                        <span><?php echo e(Str::limit($bullet, 120)); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                <?php if($import->product_dimensions || $import->product_weight): ?>
                <div style="display:flex;gap:16px;">
                    <?php if($import->product_weight): ?>
                    <div>
                        ...
                        <div style="font-size:13px;color:#374151;"><?php echo e($import->product_weight); ?></div>
                    </div>
                    <?php endif; ?>
                    <?php if($import->product_dimensions): ?>
                    <div>
                        ...
                        <div style="font-size:13px;color:#374151;"><?php echo e($import->product_dimensions); ?></div>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                ...
                <div>
                    <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:#9CA3AF;letter-spacing:0.05em;margin-bottom:8px;">
                        Images (<?php echo e(count($import->original_images)); ?>)
                    </div>
                    <div class="row g-2">
                        <?php $__currentLoopData = $import->original_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-4">
                            <a href="<?php echo e($img); ?>" target="_blank" title="Image <?php echo e($i + 1); ?> — click to open full size" style="display:block;border-radius:8px;overflow:hidden;border:1.5px solid #E5E7EB;aspect-ratio:1;background:#F3F4F6;position:relative;">
                                <img src="<?php echo e($img); ?>" alt="Product image <?php echo e($i + 1); ?>" style="width:100%;height:100%;object-fit:cover;" onerror="this.parentElement.style.display='none'">
                                <span style="position:absolute;bottom:3px;right:4px;background:rgba(0,0,0,0.55);color:white;font-size:9px;font-weight:700;padding:1px 5px;border-radius:6px;"><?php echo e($i + 1); ?></span>
                            </a>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <!-- Right: AI Generation -->
    <div class="col-lg-7">
        <?php if($import->status === 'scraped' || $import->status === 'completed'): ?>

        <?php if($latestGeneration && $latestGeneration->status === 'completed'): ?>
        <!-- Generation Exists -->
        <div class="alb-card mb-4 fade-in-up" style="border:2px solid #D1FAE5;">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:20px;">
                ...
                <div>
                    ...
                    <div style="font-size:12.5px;color:#6B7280;">AI processed <?php echo e($latestGeneration->total_tokens ?? 0); ?> tokens • <?php echo e($latestGeneration->generated_at?->diffForHumans()); ?></div>
                </div>
            </div>
            ...
            <div style="background:#F9FAFB;border-radius:10px;padding:16px;margin-bottom:16px;">
                ...
                <div style="font-size:14px;font-weight:600;color:#111827;line-height:1.5;"><?php echo e($latestGeneration->generated_title); ?></div>
            </div>

            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                <a href="<?php echo e(route('generations.view', $latestGeneration->id)); ?>" class="btn-alb-primary btn">
        ...
        <?php elseif($latestGeneration && $latestGeneration->status === 'generating'): ?>
        <!-- Generating -->
        ...
        <?php elseif($latestGeneration && $latestGeneration->status === 'failed'): ?>
        <!-- Failed -->
        <div class="alb-card mb-4 fade-in-up" style="border:1.5px solid #FCA5A5;">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:12.5px;color:#6B7280;"><?php echo e($latestGeneration->generation_error); ?></div>
                </div>
            </div>
            <form method="POST" action="<?php echo e(route('generations.generate', $import->id)); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="alb-card mb-4 fade-in-up" style="text-align:center;padding:40px 24px;">
            ...
            <div class="row g-3 justify-content-center" style="max-width:560px;margin:0 auto;">
                <div class="col-sm-6">
                    <form method="POST" action="<?php echo e(route('generations.generate', $import->id)); ?>" id="aiGenerateForm">
                        <?php echo csrf_field(); ?>
        ...
        <div class="alb-card fade-in-up" style="text-align:center;padding:48px 24px;">
            ...
            <div style="font-family:'Sora',sans-serif;font-size:18px;font-weight:700;color:#111827;margin-bottom:8px;">
                <?php if($import->status === 'pending'): ?> Queued for Scraping
                <?php elseif($import->status === 'scraping'): ?> Scraping Amazon...
                <?php else: ?> Processing...
                <?php endif; ?>
            </div>
...
<?php if(in_array($import->status, ['pending', 'scraping', 'processing']) || ($latestGeneration && $latestGeneration->status === 'generating')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/listings/show.blade.php ENDPATH**/ ?>
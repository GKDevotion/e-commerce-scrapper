...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Amazon Listing Builder</title>
...
<aside class="alb-sidebar" id="sidebar">
    <a href="<?php echo e(route('dashboard')); ?>" class="alb-sidebar-logo">
    ...
    <nav class="alb-nav-section flex-grow-1">
        <a href="<?php echo e(route('dashboard')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            <i class="bi bi-grid-1x2-fill"></i> Dashboard
        </a>

        <div class="alb-nav-label">Listings</div>
        <a href="<?php echo e(route('listings.create')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('listings.create') ? 'active' : ''); ?>">
            <i class="bi bi-plus-circle-fill"></i> New Listing
        </a>
        <a href="<?php echo e(route('listings.index')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('listings.index') ? 'active' : ''); ?>">
            <i class="bi bi-collection-fill"></i> My Listings
        </a>

        <div class="alb-nav-label">Account</div>
        <a href="<?php echo e(route('billing.plans')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('billing.*') ? 'active' : ''); ?>">
            <i class="bi bi-credit-card-fill"></i> Plans & Billing
        </a>
        <a href="<?php echo e(route('profile.index')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
            <i class="bi bi-person-fill"></i> Profile
        </a>

        <?php if(auth()->user()->isAdmin()): ?>
        <div class="alb-nav-label">Admin</div>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
            <i class="bi bi-speedometer2"></i> Admin Dashboard
        </a>
        <a href="<?php echo e(route('admin.users')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>">
            <i class="bi bi-people-fill"></i> Users
        </a>
        <a href="<?php echo e(route('admin.plans')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('admin.plans*') ? 'active' : ''); ?>">
            <i class="bi bi-layers-fill"></i> Plans
        </a>
        <a href="<?php echo e(route('admin.ai-settings')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('admin.ai*') ? 'active' : ''); ?>">
            <i class="bi bi-cpu-fill"></i> AI Settings
        </a>
        <a href="<?php echo e(route('admin.analytics')); ?>" class="alb-nav-item <?php echo e(request()->routeIs('admin.analytics') ? 'active' : ''); ?>">
    ...
    <div class="alb-sidebar-footer">
        ...
        <div style="background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;margin-bottom:12px;">
            <div style="display:flex;justify-content:space-between;font-size:11px;color:rgba(255,255,255,0.5);margin-bottom:6px;">
                ...
                <span style="color:rgba(255,255,255,0.7);"><?php echo e($user->listings_used); ?> / <?php echo e($user->plan?->listings_limit_display ?? '5'); ?></span>
            </div>
            <div class="usage-bar-track">
                <div class="usage-bar-fill" style="width:<?php echo e($user->getUsagePercentage()); ?>%"></div>
            </div>
            <?php if($user->plan): ?>
            <div style="font-size:10px;color:rgba(255,255,255,0.35);margin-top:6px;"><?php echo e($user->plan->name); ?> Plan</div>
            <?php endif; ?>
        </div>

        <a href="<?php echo e(route('profile.index')); ?>" class="alb-user-mini">
            <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>">
            <div class="info">
                <div class="name"><?php echo e($user->name); ?></div>
                <div class="plan"><?php echo e($user->plan?->name ?? 'Free'); ?></div>
            </div>
...
<header class="alb-topbar">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <a href="<?php echo e(route('listings.create')); ?>" class="topbar-btn d-none d-sm-flex">
...
<?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/layouts/app.blade.php ENDPATH**/ ?>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-lg-3 fade-in-up fade-in-up-delay-1">
        <div class="alb-stat">
            ...
            <div>
                <div class="alb-stat-value"><?php echo e($stats['total_imports']); ?></div>
    ...
    <div class="col-6 col-lg-3 fade-in-up fade-in-up-delay-2">
        <div class="alb-stat">
            ...
            <div>
                <div class="alb-stat-value"><?php echo e($stats['completed_listings']); ?></div>
    ...
    <div class="col-6 col-lg-3 fade-in-up fade-in-up-delay-3">
        <div class="alb-stat">
            ...
            <div>
                <div class="alb-stat-value"><?php echo e($stats['total_exports']); ?></div>
        ...
        <div class="alb-stat">
            ...
            <div>
                <div class="alb-stat-value" style="font-size:20px;">
                    <?php if($stats['listings_remaining'] === 'Unlimited'): ?>
                        <span style="font-size:15px;">∞</span>
                    <?php else: ?>
                        <?php echo e($stats['listings_remaining']); ?>
...
<div class="row g-4">
    ...
    <div class="col-12 fade-in-up">
        <div class="alb-card text-center" style="padding:48px 24px;">
            ...
            <a href="<?php echo e(route('listings.create')); ?>" class="btn-alb-primary btn">
    ...
    <div class="col-lg-8 fade-in-up">
        <div class="alb-card">
            <div class="alb-card-header">
                ...
                <a href="<?php echo e(route('listings.index')); ?>" style="font-size:13px;color:#E31837;text-decoration:none;font-weight:600;">View all →</a>
            </div>
            <?php if($recentGenerations->isEmpty()): ?>
                <div style="text-align:center;padding:32px;color:#9CA3AF;">
                    <i class="bi bi-inbox" style="font-size:32px;display:block;margin-bottom:10px;"></i>
                    No generations yet. <a href="<?php echo e(route('listings.create')); ?>" style="color:#E31837;">Create one →</a>
                </div>
            <?php else: ?>
            <div style="display:flex;flex-direction:column;gap:2px;">
                ...
                <a href="<?php echo e(route('generations.view', $gen->id)); ?>" style="display:flex;align-items:center;gap:14px;padding:12px;border-radius:10px;text-decoration:none;color:inherit;transition:background 0.15s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                    <!-- Thumbnail -->
                    <div style="width:50px;height:50px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#F3F4F6;display:flex;align-items:center;justify-content:center;">
                        <?php if($gen->productImport?->primary_image): ?>
                            <img src="<?php echo e($gen->productImport->primary_image); ?>" alt="" style="width:100%;height:100%;object-fit:cover;" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                    ...
                    <div style="flex:1;min-width:0;">
                        <div style="font-size:13.5px;font-weight:600;color:#111827;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            <?php echo e($gen->generated_title ?? $gen->productImport?->original_title ?? 'Untitled'); ?>

                        </div>
                        <div style="font-size:12px;color:#9CA3AF;margin-top:3px;">
                            <?php echo e($gen->brand_name); ?> • <?php echo e($gen->created_at->diffForHumans()); ?>
                    ...
                    <?php elseif($gen->status === 'generating'): ?>
    ...
    <div class="col-lg-4 fade-in-up">
        ...
        <div class="alb-card mb-4">
            <div class="alb-card-header">
                ...
                <span style="font-size:12px;color:#9CA3AF;"><?php echo e($user->plan?->name ?? 'Free'); ?> Plan</span>
            </div>
            <div>
                ...
                <div class="usage-bar-track mb-3">
                    <div class="usage-bar-fill" style="width:<?php echo e($stats['usage_percentage']); ?>%;background:<?php echo e($stats['usage_percentage'] >= 80 ? '#EF4444' : '#E31837'); ?>;"></div>
                </div>
                <?php if($stats['usage_percentage'] >= 80): ?>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('billing.plans')); ?>" style="display:block;text-align:center;background:#FEE2E8;color:#E31837;border-radius:9px;padding:10px;font-size:13px;font-weight:700;text-decoration:none;transition:background 0.15s;" onmouseover="this.style.background='#FECDD3'" onmouseout="this.style.background='#FEE2E8'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/dashboard/index.blade.php ENDPATH**/ ?>
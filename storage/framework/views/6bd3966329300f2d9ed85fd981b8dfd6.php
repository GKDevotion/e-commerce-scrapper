...
<?php $__env->startSection('page-title', 'AI Settings'); ?>
...
<div class="row g-4">
    ...
    <div class="col-lg-6 fade-in-up">
        <div class="alb-card">
            ...
            <form method="POST" action="<?php echo e(route('admin.ai-settings.update')); ?>">
                <?php echo csrf_field(); ?>
                <div class="alb-form-group">
                    ...
                    <div style="position:relative;">
                        <input type="password" name="openai_api_key" class="alb-input" id="apiKey"
                            placeholder="sk-..." value="<?php echo e(config('services.openai.key') ? '••••••••••••••••' : ''); ?>">
                ...
                <div class="alb-form-group">
                    ...
                    <select name="openai_model" class="alb-input">
                        <?php $__currentLoopData = ['gpt-4o','gpt-4o-mini','gpt-4-turbo','gpt-3.5-turbo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m); ?>" <?php echo e(config('services.openai.model') === $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
    ...
    <div class="col-lg-6 fade-in-up fade-in-up-delay-1">
        <div class="alb-card">
            <div class="alb-card-header">
                ...
                <span style="font-size:12px;color:#9CA3AF;"><?php echo e($templates->count()); ?> templates</span>
            </div>
            ...
            <div style="border:1.5px solid #E5E7EB;border-radius:10px;padding:14px;margin-bottom:10px;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                    <div style="font-size:13.5px;font-weight:700;color:#111827;"><?php echo e($tpl->name); ?></div>
                ...
                <div style="font-size:12px;color:#9CA3AF;"><?php echo e($tpl->description); ?></div>
                <div style="font-size:11.5px;color:#6B7280;margin-top:6px;background:#F9FAFB;border-radius:6px;padding:8px;font-family:monospace;">
                    Model: <?php echo e($tpl->ai_model); ?> | Tokens: <?php echo e($tpl->max_tokens); ?> | Temp: <?php echo e($tpl->temperature); ?>
    ...
    <div class="col-12 fade-in-up fade-in-up-delay-2">
        <div class="alb-card">
            ...
            <div class="row g-3">
                ...
                ?>
                <?php $__currentLoopData = $aiStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $icon, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-md-2">
                    <div style="text-align:center;padding:16px;background:#F9FAFB;border-radius:12px;">
                        <i class="bi <?php echo e($icon); ?>" style="font-size:24px;color:<?php echo e($color); ?>;display:block;margin-bottom:8px;"></i>
                        <div style="font-family:'Sora',sans-serif;font-size:18px;font-weight:800;color:#111827;"><?php echo e($value); ?></div>
                        <div style="font-size:11.5px;color:#9CA3AF;"><?php echo e($label); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/admin/ai-settings.blade.php ENDPATH**/ ?>
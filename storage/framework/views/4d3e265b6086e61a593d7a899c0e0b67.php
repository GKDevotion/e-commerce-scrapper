...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> — Amazon Listing Builder</title>
...
<div class="auth-bg-dots" aria-hidden="true">
    <?php for($i = 0; $i < 8; $i++): ?>
    <div class="dot" style="
        width: <?php echo e(rand(40, 120)); ?>px;
        height: <?php echo e(rand(40, 120)); ?>px;
        left: <?php echo e(rand(0, 100)); ?>%;
        animation-duration: <?php echo e(rand(15, 30)); ?>s;
...
<?php /**PATH S:\Devotion\www\laravel\amazon-ai-listing-builder\resources\views/layouts/auth.blade.php ENDPATH**/ ?>